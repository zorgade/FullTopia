...
package com.androApp.hevs.fulltopia.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.androApp.hevs.fulltopia.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Note: Ensure that the Fulltopia-c59b334abe19.json has read
        // permissions set.
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/Fulltopia-c59b334abe19.json"))
                .setDatabaseUrl("https://fulltopia-44b7f.firebaseio.com/")
                .build();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("app.hevs@gmail.com", "Recipient"));
